...
const matchExpenseDetailsSchema = z.object({
  ...
  commissioner: z.coerce.number().min(0).default(0),
  observer: z.coerce.number().min(0).default(0),
  doctor: z.coerce.number().min(0).default(0),
  travelAllowance: z.coerce.number().min(0).default(0),
  travelReferees: z.coerce.number().min(0).default(0),
  travelJudges: z.coerce.number().min(0).default(0),
  travelCommissioner: z.coerce.number().min(0).default(0),
  travelObserver: z.coerce.number().min(0).default(0),
