...
import { applyCoachChrome, coachAppPath } from '../utils/parentApp';
import { LoginPage } from './LoginPage';
import { CoachPortalPage } from './CoachPortalPage';
...
export function CoachAppPage() {
  ...
  if (!session) {
    return <LoginPage portalApp="coach" />;
  }
    ...
    return (
      <div className="parent-app-wrong-role">
        ...
        <button
          ...
          onClick={() => {
            logout();
            window.location.assign(coachAppPath());
          }}
        >
          Έξοδος
        </button>
    ...
    <div className="parent-app-shell">
      <header className="parent-app-bar">
        <div className="parent-app-bar-brand">
          ...
          <div>
            <strong>{club?.name || 'TeamSuite Προπονητές'}</strong>
