    ...
    <div className="public-join-page">
      <div className="public-join-shell">
        ...
        <form className="public-join-card" onSubmit={(e) => void handleSubmit(e)}>
          ...
          <>
          <p className="lede">
            Συμπληρώστε τα στοιχεία του αθλητή και του γονέα/κηδεμόνα.
            {club.licenseFull
              ? ' Θα μπείτε σε λίστα αναμονής μέχρι να ελευθερωθεί θέση στο πακέτο αδειών.'
              : ' Θα λάβετε email επιβεβαίωσης και ο σύλλογος θα ελέγξει την αίτηση πριν ενεργοποιήσει τον αθλητή.'}
          </p>
