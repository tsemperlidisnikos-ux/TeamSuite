...
export function StudentsPage() {
  ...
  const classOptions = useMemo(
    () =>
      [...visibleClasses].sort((a, b) => a.name.localeCompare(b.name, 'el')),
    [visibleClasses],
  );
    ...
    <div className="stack-lg">
            ...
            {filtered.map((student) => {
              ...
              return (
                ...
                >
                  ...
                  <td>{studentSports(student).join(', ') || '—'}</td>
                  <td>
                    {isDoctor
      ...
      <SpreadsheetImportHelpModal
        ...
        steps={[
          ...
          "Τα τμήματα πρέπει να γράφονται όπως ακριβώς είναι καταχωρημένα στο πρόγραμμα (π.χ. ΠΑΙΔΙΚΟ Α' ), χωρισμένα με κόμμα αν είναι περισσότερα από ένα.",
