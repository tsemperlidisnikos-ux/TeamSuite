        ...
        <div className="settings-form-row settings-backup-block">
          <div className="settings-form-row-label settings-backup-copy">
            ...
            <p>
              ...
              . JSON από Google Drive: κατεβάστε το αρχείο από τον φάκελο TeamSuite-Backups και
              επιλέξτε το εδώ. Δεν αλλάζει τους λογαριασμούς σύνδεσης. Απορρίπτει πλήρη backup
              πλατφόρμας. Αν το αρχείο είναι άλλου συλλόγου, χρειάζεται δεύτερη επιβεβαίωση
              (πληκτρολογήστε ΜΕΤΑΦΟΡΑ).
            </p>
          </div>
          <div className="settings-form-row-content settings-backup-panel">
            <label
            ...
            <p>
              ...
              {lastSync ? (
                <>
                  ...
                  {new Date(lastSync).toLocaleString('el-GR')}
                  {Date.now() - (Date.parse(lastSync) || 0) >= 24 * 60 * 60 * 1000
                    ? ' — παλιό: το νυχτερινό Drive αντιγράφει μόνο αυτό το mirror.'
                    : ''}
                </>
              ) : (
                <>
                  <br />
                  Δεν έχει γίνει ακόμα επιτυχές Push από αυτόν τον browser.
                </>
              )}
            </p>
            {!isDemoClub ? (
