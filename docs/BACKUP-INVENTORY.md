...
Τελευταία ενημέρωση περιεχομένου: **2026-09-21** (ZIP `C:\TeamSuite_backup` + deploy `teamsuite`).
...
|------------------|------------|-------------------------------------|
| `TeamSuite_2026-09-21_14-52-50.zip` | 2026-09-21 | Έξοδα: ανενεργό άθλημα/τμήμα σε Προσωπικό και Διοικητικά · ρόλος προσωπικού «Διάφορα» · localhost proxy `/api` ώστε να μην σπάει το Vite στο club-media |
